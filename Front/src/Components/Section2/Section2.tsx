...
const Section2 = () => {
  return (
    <div className="bg-black min-h-[100px] flex items-center p-6 md:m-4">
      <div className="flex flex-col gap-6 md:gap-0 md:flex-row w-full">
        {/* Contenedor de la izquierda */}
        <div className="flex-1 flex items-center justify-around md:justify-start md:mb-0 lg:pl-[100px]">
          <h2 className="text-white text-2xl lg:text-2xl xl:text-3xl text-center md:text-left">
            ¡Bienvenido a nuestra agencia!
          </h2>
        </div>

        {/* Contenedor de la derecha */}
        <div className="flex-1 flex items-center justify-center px-4 md:px-9 lg:pr-[100px]">
          <p className="text-white text-base xl:text-lg text-center md:text-left">

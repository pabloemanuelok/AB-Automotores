...
const Section2 = () => {
  return (
    <div className="bg-black min-h-[100px] flex items-center mb-4 md:mx-4">
      <div className="flex flex-col gap-4 md:gap-0 md:flex-row w-full min-h-[300px]">
        {/* Contenedor de la izquierda */}
        <div className="flex-1 flex items-center justify-around md:justify-start md:mb-0 lg:pl-[100px] mt-8">
        ...
        <div className="flex-1 flex items-center justify-center px-4 md:px-9 lg:pr-[100px] mb-8">
